...
import com.example.whattsapp_clone.databinding.ActivitySettingBinding;
...
public class SettingActivity extends AppCompatActivity {
        ...
        database.getReference().child("User").child(FirebaseAuth.getInstance().getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Picasso.get().load(user.getProfilepic()).placeholder(R.drawable.avatar).into(binding.profile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data.getData() != null){
            ...
            final StorageReference reference = storage.getReference().child("Profile Images").child(FirebaseAuth.getInstance().getUid());
